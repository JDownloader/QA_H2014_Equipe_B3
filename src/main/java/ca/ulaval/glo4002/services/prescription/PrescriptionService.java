...
public class PrescriptionService {
	...
	public void addPrescription(AddPrescriptionRequestParser requestParser) throws ServiceRequestException {
		try {
	...
	private Drug getDrug(AddPrescriptionRequestParser requestParser) throws ServiceRequestException {
		try {
