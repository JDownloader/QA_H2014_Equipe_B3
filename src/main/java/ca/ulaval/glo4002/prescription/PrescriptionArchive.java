...
public class PrescriptionArchive {
	 ...
	 * 
	 * je pense qu'il faudrait que je fasse un builder dans prescription et que
	 * cela soit appeler par add, comme cela le id serait autoincrement et on
	 * pourrait implenter get(), qui est plus rapide que la technique
	 * itterative.
	 * 
	 * -vince L-G
	 * 
