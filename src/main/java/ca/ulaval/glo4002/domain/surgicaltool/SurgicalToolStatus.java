...
public enum SurgicalToolStatus implements Serializable {
	UTILISE_PATIENT("Utilise_Patient"), SOUILLE("Souille"), TERMINEE("Inutilise");
	...
	public static SurgicalToolStatus fromString(String statusName) {
		...
		throw new IllegalArgumentException(String.format("'%s' is not a valid value for enumeration SurgicalToolStatus.", statusName));
	}
}
