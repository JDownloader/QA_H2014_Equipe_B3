...
public class PrescriptionCreationRequestParserTest {
	...
	private PrescriptionCreationRequestParser addPrescriptionRequestParser;
	private JSONObject jsonRequest = new JSONObject();

	@Before
	public void init() throws Exception {
		jsonRequest.put(PrescriptionCreationRequestParser.STAFF_MEMBER_PARAMETER_NAME, SAMPLE_STAFF_MEMBER_PARAMETER);
		jsonRequest.put(PrescriptionCreationRequestParser.DATE_PARAMETER_NAME, SAMPLE_DATE_PARAMETER);
		jsonRequest.put(PrescriptionCreationRequestParser.RENEWAL_PARAMETER_NAME, SAMPLE_RENEWALS_PARAMETER);
		jsonRequest.put(PrescriptionCreationRequestParser.DIN_PARAMETER_NAME, SAMPLE_DIN_PARAMETER);
		jsonRequest.put(PrescriptionCreationRequestParser.PATIENT_NUMBER_PARAMETER_NAME, SAMPLE_PATIENT_NUMBER_PARAMETER);
		createRequestParser();
	}

	private void createRequestParser() throws Exception {
		addPrescriptionRequestParser = new PrescriptionCreationRequestParserFactory().createParser(jsonRequest);
	}
	...
	public void disallowsEmptyDrugName() throws Exception {
		jsonRequest.remove(PrescriptionCreationRequestParser.DIN_PARAMETER_NAME);
		jsonRequest.put(PrescriptionCreationRequestParser.DRUG_NAME_PARAMETER_NAME, "");
		createRequestParser();
	}
	...
	public void disallowsDrugAndDrugNameParametersBothSpecified() throws Exception {
		jsonRequest.put(PrescriptionCreationRequestParser.DRUG_NAME_PARAMETER_NAME, SAMPLE_DRUG_NAME_PARAMETER);
		createRequestParser();
	}

	@Test(expected = RequestParseException.class)
	public void disallowsUnspecifiedStaffMemberParameter() throws Exception {
		jsonRequest.remove(PrescriptionCreationRequestParser.STAFF_MEMBER_PARAMETER_NAME);
		createRequestParser();
	}

	@Test(expected = RequestParseException.class)
	public void disallowsUnspecifiedRenewalsParameter() throws Exception {
		jsonRequest.remove(PrescriptionCreationRequestParser.RENEWAL_PARAMETER_NAME);
		createRequestParser();
	}

	@Test(expected = Exception.class)
	public void disallowsUnspecifiedDateParameter() throws Exception {
		jsonRequest.remove(PrescriptionCreationRequestParser.DATE_PARAMETER_NAME);
		createRequestParser();
	}

	@Test(expected = RequestParseException.class)
	public void disallowsNegativeStaffMemberParameter() throws Exception {
		jsonRequest.put(PrescriptionCreationRequestParser.STAFF_MEMBER_PARAMETER_NAME, "-1");
		createRequestParser();
	}

	@Test(expected = Exception.class)
	public void disallowsNegativeRenewalsParameter() throws Exception {
		jsonRequest.put(PrescriptionCreationRequestParser.RENEWAL_PARAMETER_NAME, "-1");
		createRequestParser();
	}

	@Test(expected = RequestParseException.class)
	public void disallowsNegativePatientParameter() throws Exception {
		jsonRequest.put(PrescriptionCreationRequestParser.PATIENT_NUMBER_PARAMETER_NAME, "-1");
		createRequestParser();
	}

	@Test(expected = RequestParseException.class)
	public void disallowsInvalidDateParameter() throws Exception {
		jsonRequest.put(PrescriptionCreationRequestParser.DATE_PARAMETER_NAME, SAMPLE_INVALID_DATE_PARAMETER);
		createRequestParser();
	}

	@Test
	public void allowsMinimumDinParameter() throws Exception {
		jsonRequest.put(PrescriptionCreationRequestParser.DIN_PARAMETER_NAME, MIN_DIN_PARAMETER);
		createRequestParser();
	}

	@Test
	public void allowsMinimumStaffMemberParameter() throws Exception {
		jsonRequest.put(PrescriptionCreationRequestParser.STAFF_MEMBER_PARAMETER_NAME, MIN_STAFF_MEMBER_PARAMETER);
		createRequestParser();
	}

	@Test
	public void allowsMinimumRenewalsParameter() throws Exception {
		jsonRequest.put(PrescriptionCreationRequestParser.RENEWAL_PARAMETER_NAME, MIN_RENEWALS_PARAMETER);
		createRequestParser();
	}

	@Test
	public void allowsMinimumPatientNumberParameter() throws Exception {
		jsonRequest.put(PrescriptionCreationRequestParser.PATIENT_NUMBER_PARAMETER_NAME, MIN_PATIENT_NUMBER_PARAMETER);
		createRequestParser();
	}
